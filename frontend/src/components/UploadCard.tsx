  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-10 py-14">
      ...
      <div
        ...
        className={[
          "mt-9 flex flex-col items-center justify-center rounded-2xl border-2 border-dashed px-8 py-9 text-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-500)]",
